...
export default function RootLayout({
  ...
  const legalLinks = ["Privacy Policy", "Legal", "Supply Chain Transparency"];
  ...
  return (
    <html lang="en" className={fonts.signika.variable}>
      <body className={fonts.signika.className}>
        <Providers>
          <Header bg={"#F45436"} headerLinks={headerLinks} supportLinks={supportLinks}/>
          {children}
          <Footer navLinks={footerLinks} legalLinks={legalLinks} />
        </Providers>
      </body>
    </html>
  );
